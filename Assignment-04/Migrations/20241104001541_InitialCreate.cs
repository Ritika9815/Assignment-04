        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyQuote = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceQuotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsuranceQuotes_Customers_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceQuotes_CustomerId",
                table: "InsuranceQuotes",
                column: "CustomerId");
        }
